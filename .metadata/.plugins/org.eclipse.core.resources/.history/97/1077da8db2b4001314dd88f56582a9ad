...
public final class Parameters 
{
	...
	// Server Log File Names
	public static String log_NA = "log_NA.log";
	public static String log_EU = "log_EU.log";
	public static String log_AS = "log_AS.log";
	// Server Database File Names
	public static String database_NA = "database_NA.txt";
	public static String database_EU = "database_EU.txt";
	public static String database_AS = "database_AS.txt";
